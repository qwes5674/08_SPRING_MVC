...
public class ResolveController {
    ...
    public String stringReturning(Model model) {
        ...
        * ThymeleafViewReoslver에게 resources/templates/ 를 prefix로 지정하고
        * .html 을 suffix 로 하여
    ...
    public ModelAndView modelAndView(ModelAndView mv) {
        ...
        * ModelAndView
        *  모델과 뷰를 합친 개념
        *  핸들러 어뎁터가 핸들러 메소드를 호출하여 반환받은 문자열 ModelAndView로 만들어
        *  DispatcherServlet에 반환한다.
        *  이때 문쟈열을 반환해도 되고, ModelAndView 객체를 만들어서 반환 할 수 도 있다.
        * */

        // 속성값 담기
        mv.addObject("forwardMessage",
                "ModelAndView를 이용한 모델과 뷰 변환");
